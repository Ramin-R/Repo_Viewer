...
final starredReposeRemoteServiceProvider = Provider(
...
final starredReposRepositoryProvider = Provider(
  (ref) => StarredReposRepository(
    ref.watch(starredReposeRemoteServiceProvider),
...
final searchedReposeRemoteServiceProvider = Provider(
...
final searchedReposRepositoryProvider = Provider(
  (ref) => SearchedReposRepository(
    ref.watch(searchedReposeRemoteServiceProvider),
  ),
);
...
final repoDetailNotifierProvider =
  ...
  (ref) => RepoDetailNotifier(ref.watch(repoDetailRepository)),
);
