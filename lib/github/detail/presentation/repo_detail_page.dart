          ...
          actions: [
            state.maybeMap(
              ...
              loadSuccess: (state) {
                return IconButton(
                  onPressed: () =>
                      ref.read(repoDetailNotifierProvider.notifier).switchStarredStatus(),
                  icon: Icon(
                    state.repoDetail.entity?.starred == true ? Icons.star : Icons.star_outline,
                  ),
                );
              },
            )
          ...
          loadSuccess: (_) {
            if (_.repoDetail.entity == null) {
              return const NoResultsDisplay(
                message: "These are all the details we could find about this repo.",
              );
            }
