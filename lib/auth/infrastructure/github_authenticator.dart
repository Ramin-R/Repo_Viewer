...
class GithubAuthenticator {
  ...
  Future<bool> isSignedIn() => getSignedInCredentials().then((c) => c != null);
  ...
  Future<Either<AuthFailure, Unit>> signOut() async {
    // final usernameAndPassword = base64Encode(utf8.encode('$clientId:$clientSecret'));

    try {
      final accessToken = await _credentialsStorage.read().then((c) => c?.accessToken);
